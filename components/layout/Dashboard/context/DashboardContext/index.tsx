  ...
  switch (action.type) {
    ...
    case 'TOGGLE_DRAWER_POSITION':
      window.localStorage.setItem(
        ...
        JSON.stringify(state.drawerPosition === 'left' ? 'right' : 'left')
      );

      return {
        ...state,
        drawerPosition: state.drawerPosition === 'left' ? 'right' : 'left',
      };
...
export const DashboardProvider: React.FC<React.PropsWithChildren<unknown>> = ({
  children,
}) => {
