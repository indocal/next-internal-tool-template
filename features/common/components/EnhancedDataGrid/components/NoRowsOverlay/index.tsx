...
export const EnhancedDataGridNoRowsOverlay: React.FC = () => {
  return (
    <GridOverlay
      sx={{
        display: 'flex',
    ...
    >
      <svg width={200} height={50} viewBox="0 0 200 150" focusable="false">
...
export default EnhancedDataGridNoRowsOverlay;
